var stemclass = "technoligy";
let myName = "Alfonso"

console.log(`This code was writen in the STEM PREP ${stemclass} class`);

alert(`This code was writen in the STEM PREP ${stemclass} class by ${myName}`);
